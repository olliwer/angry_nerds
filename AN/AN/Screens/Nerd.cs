...
namespace AN
{
    class Nerd : Sprite
    {
        ...
        private void UpdateMouseMovement(MouseState aCurrentMouseState)
        {
            ...
            if (aCurrentMouseState.LeftButton == ButtonState.Pressed && painettuna == false && ammuttu == false && aCurrentMouseState.X > 130 && aCurrentMouseState.X < 200 && aCurrentMouseState.Y < 660 && aCurrentMouseState.Y > 550)
            {
